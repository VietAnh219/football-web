    ...
    return (
        <div className="w-full h-full relative rounded-2xl overflow-hidden">
            <div className="w-full h-[500px] relative rounded-2xl overflow-hidden mb-6">
                <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url("/LaLiga.jpeg")` }} />
            </div>
            <div className="bg-white rounded-2xl px-6 py-8 h-full">
                ...
                <FadeInSection>
                    {isLoading ? <SkeletonCard /> : <ClubStatSection title="La Liga Club Stats" stats={clubStats ?? []} />}
                </FadeInSection>
